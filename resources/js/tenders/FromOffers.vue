        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="text-center font-weight-bold">
              .تم ارسال طلبك بنجاح سيتم التواصل معكم قريباُ
            </div>
          </div>
        </div>
      </div>
    ...
    >
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="modal-body">
            <div class="text-center font-weight-bold">
              ملاحظة : اي زيادة او نقصان في المواصفات سوف يتم تعديل على تكلفة
              البناء
            </div>
          </div>
        </div>
        ...
        <div class="contact-form">
          <div class="card-body" v-for="(offer, index) in offers" :key="index">
                            ...
                            <form>
                              ...
                              <div class="form-group">
                                ...
                                <input
                                  type="text"
                                  class="form-control"
                                  placeholder="Mob : (971) - XXX-XXXXXX"
                                  v-model="phone"
                                  dir="ltr"
                                />
                              </div>
                              ...
                              <div class="form-group">
                                ...
                                <input
                                  type="text"
                                  class="form-control"
                                  placeholder="Whatsapp : (971) - XXX-XXXXXX"
                                  v-model="whatsapp"
                                  dir="ltr"
                                />
                              </div>
                              <div class="form-group">
                                <label class="form-control">
                                  ...
                                  <span
                                    ...
                                    @click="$refs.fileinput"
                                    v-else
                                    ><i class="text-success fas fa-images"></i
                                  ></span>
                                  {{ $t("Emirates_id") }}
                                  <small
                                    class="text-danger font-weight-bold"
                                    v-if="FileNotpassportAllowd != null"
                                    >{{ FileNotpassportAllowd }}</small
                                  >
                ...
                <textarea class="form-control"> </textarea>
                              ...
                              <div class="text-right form-group" dir="rtl">
                                ...
                                >
                                  ...
                                  ></span>
                                  <span class="mr-4 ml-4"
                                    >برنامج الشيخ زايد للاسكان</span
                                  >
                                </label>
                                <label
                                  class="checkbox d-bolck"
                                ...
                                >
                                  ...
                                  ></span>
                                  <span class="mr-4 ml-4"
                                    >برنامج الشيخ محمد بن راشد للاسكان</span
                                  >
                                </label>
                                <label
                                  class="checkbox d-bolck"
                                ...
                                >
                                  ...
                                  ></span>
                                  <span class="mr-4 ml-4"
                                    >برنامج الشارقة للاسكان اسناد</span
                                  >
                                </label>
                                <label
                                  class="checkbox d-bolck"
                              ...
                              <div class="text-right">
                                <p class="theme-color font-weight-bold">
                                  البنك الممول اللمنحة
                                  <sup class="text-danger"> (اختياري)</sup>
                                </p>
                                <div class="form-group">
                                  <input
            ...
            <form class="c-form-inner" v-if="o_form">
              <div class="text-right form-group" dir="rtl">
                <label for=" h6"
                  ><span class="h6 font-weight-bold thm-color"> العنوان </span>
                </label>
                <p>
                  {{ offer.title }}
                </p>
              ...
              <div class="form-group">
                <div class="form-group mt-3">
                  <label for="exampleFormControlTextarea1"
                    ><span class="thm-color">الوصف</span></label
                  >
              ...
              <div class="row">
                <div class="col-6">
                  <div class="font-weight-bold h6 mt-3 text-right thm-color">
                    اختار نوع الفيلا
                  </div>
              ...
              <div class="rooms">
                ...
                <div class="form-group text-right">
                    ...
                    <span class="mr-4 ml-4">
                      ...
                      <sub>
                        <span class="text-muted"
                          >غرفة خادمة + مطبخ رئيسي + مخزن</span
                        >
                      </sub>
                    </span>
                  </label>
                  ...
                  <label class="checkbox d-bolck" :dir="$t('directions')">
                    ...
                    />
                    <span class="check" style="border-radius: 10px"></span>
                    <span class="mr-4 ml-4"> خارج الفيلا </span>
                  </label>
                </div>
                    ...
                    <div class="col-12">
                      <div class="single-property-details">
                        <label
                          ...
                          >
                            <span class="current">
                              <all-uae :emirates="emirates_selected"></all-uae
                            ></span>
                            <ul class="list">
                              <li
                                data-value="1"
         ...
         tabindex="0" @click="open('finishing')">
            <span class="current">
              ...
              <li data-value="1" class="option " @click="finshing(1)">{{$t('commercial')}}</li>
                ...
                <div class="includes">
                  <h3 class="mt-3 mb-3 text-muted h5" :class="$t('text_align')">
                    العرض يشمل
                  </h3>
