...
class UserController extends Controller
{
        ...
        $fileUpload = new achivement();
            ...
            $fileUpload = new CompanyFile();
                ...
                foreach ($request->filename as $file) {
                    ...
                    $FilesAdditional->path =  $file;
                    $FilesAdditional->user_id =   $user->id;;
    ...
    public function imagesSignup(Request $request){
        // return $request;
        if ($request->hasFile('file')) {
            ...
            // foreach ($images as $image) {
                ...
                $file_name = 'amb_FilesAdditional' . time() . '_' . $images->getClientOriginalName();
                $file_extension = $images->getClientOriginalExtension();
                $names = $file_name;
                $file_path = $images->storeAs('FilesAdditional', $file_name, 'public');
                $images->move(public_path('FilesAdditional'), $file_name);
